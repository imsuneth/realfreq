...
echo_bams | ex ./realfreq -r test/tmp/genome_chr22.fa -o test/tmp/test1.tsv || die "Test 1 failed running realfreq"
...
echo_bams | ex ./realfreq -r test/tmp/genome_chr22.fa -o test/tmp/test2.bedmethyl -b || die "Test 2 failed running realfreq"
