...
# Source files
SRCS = src/error.c src/file_handler.c src/logger.c src/main.c src/misc_p.c src/misc.c src/mod.c src/thread.c src/minimod.c src/meth.c src/ref.c src/server.c
